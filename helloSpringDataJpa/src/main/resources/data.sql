...
insert into product (name, brand, made_in, price) values ('iPhone16', 'Apple', 'China',  1000);
insert into product (name, brand, made_in, price) values ('iPhone15', 'Apple', 'China',  1000);
